...
{
  "listingTitle": "string — Etsy title per the April 2026 guidance: [What the item IS + top objective traits] | [Distinctive theme or feature]. State the item noun ONCE, front-load the exact buyer phrase in the first ~40 chars, ≤140 chars AND ≤14 words. NO gifting phrases ('gift for her', 'personalized gift' — those go in tags/description), occasion words only if essential to the item itself (e.g. 'Gotcha Day Bandana'), no subjective/sale/shipping words, never repeat a significant word, no copyrighted brands",
