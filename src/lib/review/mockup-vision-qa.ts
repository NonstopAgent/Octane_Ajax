...
2. TEXT: every word in the artwork must be correctly spelled, real English, and legible. Garbled, invented, or misspelled words are a FAIL. Literal bracketed or template placeholder text rendered IN the design — like "[name]", "[gotcha date]", "{date}", "Your Name Here" — is a FAIL (sample names/dates without brackets are fine).
